...
describe('ServiceRequestsService', () => {
  ...
  it('files a request under the caller branch with server-owned fields', async () => {
    const { repo } = makeRepo();
    const service = new ServiceRequestsService(repo, makeHistory(), makeFleet(null), makeCim(null));
  ...
  it('links a same-branch customer when customerId is supplied', async () => {
    ...
    const service = new ServiceRequestsService(repo, makeHistory(), makeFleet(null), cim);
  ...
  describe('dispatch', () => {
    it('assigns the rider, stamps dispatch, and flips the rider to On Delivery', async () => {
      ...
      const service = new ServiceRequestsService(repo, makeHistory(), fleet, makeCim(null));
