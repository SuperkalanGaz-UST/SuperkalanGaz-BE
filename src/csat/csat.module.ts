...
/**
 * CSAT module — two Branch Manager flows: closed-loop follow-up on low-rated
 * deliveries (BM-US-08) and logging a lost/undelivered cylinder complaint
 * (BM-US-04). ServiceRequest and Rider are registered so both queues can enrich
